        ...
        <div class="card border-0 rounded-4 shadow p-4">
            ...
            <!-- نوع المستخدم -->
                ...
                <p class="text-center text-secondary mb-0">
                    ليس لديك حساب؟ 
                    <a href="<?php echo e(route('register')); ?>" class="link-primary text-decoration-none">إنشاء حساب</a>
                </p>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\school management system\school\resources\views/login.blade.php ENDPATH**/ ?>