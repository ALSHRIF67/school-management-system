                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-light rounded p-4">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="<?php echo e(asset('img/user.jpg')); ?>" alt="" style="width: 40px; height: 40px;">
...
<?php echo $__env->make('frotend.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\school management system\school\resources\views/frotend/master.blade.php ENDPATH**/ ?>