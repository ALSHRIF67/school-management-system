...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('teacherDashboard') }}">لوحة المعلم</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a href="{{ route('teacher.studentTable') }}" class="nav-link active">الطلاب</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <tbody>
                        @forelse($students ?? [] as $student)
                            <tr>
                                ...
                                <td>{{ $student->class ?? '-' }}</td>
                                <td>
                                    <form action="{{ route('teacher.students.remove', $student->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal fade" id="addStudentModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('teacher.students.add') }}" method="POST">
                    @csrf
